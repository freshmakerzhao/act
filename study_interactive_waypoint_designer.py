...
slider_left = 0.62
slider_width = 0.32
slider_bottom_start = 0.35

ax_slider_x = plt.axes([slider_left, slider_bottom_start + 2*slider_gap, slider_width, slider_height])
ax_slider_y = plt.axes([slider_left, slider_bottom_start + slider_gap, slider_width, slider_height])
ax_slider_z = plt.axes([slider_left, slider_bottom_start, slider_width, slider_height])
...
def update(val):
    ...
    # Display info with larger font (English only)
    ax_info.clear()
    ax_info.axis('off')
...
def save_waypoint(event):
    ...
    print(f"    t={wp['t']}, xyz={wp['xyz']}, offset={wp['offset']}")
...
def export_code(event):
    ...
    for i, wp in enumerate(waypoints):
        ...
        print(f'    {{"t": {wp["t"]}, '
              ...
              f'"quat": gripper_pick_quat.elements, '
              f'"gripper": {gripper_state}}},  # {comment}')
